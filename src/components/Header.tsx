...
//     <img width="20" height="20" src="https://img.icons8.com/ios-filled/50/ffffff/facebook-new.png" alt="facebook-new" />
//     <img width="20" height="20" src="https://img.icons8.com/ios/50/ffffff/youtube-play--v1.png" alt="youtube-play--v1" />
//     <img width="20" height="20" src="https://img.icons8.com/windows/32/ffffff/instagram-new.png" alt="instagram-new" />
//     <img width="20" height="20" src="https://img.icons8.com/ios/50/ffffff/twitterx--v2.png" alt="twitterx--v2" />
//   </div>
...
// <div className="relative w-full h-screen bg-cover bg-top" style={{ backgroundImage: "url('/Shopify3.jpg')" }}>
...
//       <a href="#" className="hover:text-green-300 transition">STORE</a>
//       <a href="#" className="hover:text-green-300 transition">OUR STORY</a>
//       <a href="#" className="hover:text-green-300 transition">DEMONS</a>
//     </nav>
